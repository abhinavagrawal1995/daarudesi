...
<html>
	<head>
		<title>Happy Birthday Ria!</title>
		<meta charset="utf-8" />
			...
			<div id="main">
				...
				<!-- Header -->
					<header id="header">
						...
						<p>This is 2</p>
						<ul class="icons">
							<li><a href="index.php" class="icon fa-twitter"><span class="label">Twitter</span></a></li>
							<li><a href="index1.php" class="icon fa-instagram"><span class="label">Instagram</span></a></li>
							<li><a href="index2.php" class="icon fa-github"><span class="label">Github</span></a></li>
						</ul>
					</header>
